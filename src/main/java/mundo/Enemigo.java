...
public abstract class Enemigo implements SerViviente {
  ...
  protected short posAleatoriaX() {
    int posAleatoria = (int) (Math.random() * SurvivorCamp.ANCHO_PANTALLA / 3)
        + SurvivorCamp.ANCHO_PANTALLA / 3 - 75;
  ...
  /**
   * comprueba que las posiciones de la bala coincidan con la posici�n del enemigo y reduzca su
   * salud en caso de ser afectado
   * 
   * @param x
   * @param y
   * @param danio
