...
public class SurvivorCamp implements Cloneable, Comparator<Puntaje> {
	...
	/**
	 * entero incambiable que representa el n�mero de zombies que aparecen en una
	 * ronda
	 */
	 ...
	 * lista facilmente nodo m�s cercano al personaje (abajo)
	 */
	private Zombie zombNodoLejano;
	/**
	 * Zombie que no aparece en el juego pero sirve como nodo para modificar la
	 * lista facilmente nodo m�s lejano al personaje (arriba)
	 */
	...
	/**
	 * ronda en la que se encuentra la partida actual, var�a desde 1 a 10, en la
	 * 10 s�lo puede estar el jefe
	 */
	...
	/**
	 * n�mero que representa el arma que se est� mostrando en las
	...
	/**
	 * cambia la ronda en la que se encuentra, en general sube una ronda, pero si se
	 * carga una partida puede variar
	 */
	...
	public Zombie generarZombie(int nivel) {
		...
		if ((level == 3 || level == 4 || level == 8))
			...
			tipoZombie = 1;
		Zombie aGenerar = new Caminante(level, zombNodoLejano);

		if (tipoZombie == 1) {
			aGenerar = new Rastrero(level, zombNodoLejano);
		}

		if (cantidadZombiesGenerados == 1) {
	...
	/**
	 * cambia los estados del personaje con corde a que recibe un ara�azo zombie,
	 * termina el juego si muere
	 */
	 ...
	 * 
	 * @throws IOException            en caso de que no se haya guardado alg�n
	 *                                puntaje
	 * @throws ClassNotFoundException en caso de que haya ocurrido un error al
	 *                                guardar los datos
	 */
	 ...
	 * 
	 * @param carpeta
	 * @param personaje para asignarselo a la partida si todos los datos son
	 *                  v�lidos
	...
	/**
	 * m�todo auxiliar para generar un boss con respecto a la salud que le entra
	 * por par�metro
	 * 
	 * @param ronda
	 * @param salud
	...
	/**
	 * m�todo auxiliar que verifica las direcciones a las que se mueven los
	...
	/**
	 * verifica que los datos generales de loz zombies est�n dentro de los
	 * l�mites del juego
	 * 
	 * @param posX
	 * @param posY
	...
	/**
	 * devuelve el n�mero de referencia al arma que se encuentra a la izquierda de
	 * la actual
	 * 
	 * @return n�mero del arma Mostrada
	 */
	 ...
	 * 
	 * @throws IOException en caso de que ocurra un problema al guardar la ra�z
