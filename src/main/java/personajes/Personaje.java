...
public class Personaje implements SerViviente, Serializable {
  ...
  /**
   * cuchillo del personaje, es usado cuando un zombie ataca y no tiene la posibilidad de usar otra
   * arma
   */
  ...
  /**
   * Constructor del personaje cada vez que se inicia una partida los valores no inicializados
   * tienen por defecto 0
   */
  public Personaje() {
    salud = SALUD;
