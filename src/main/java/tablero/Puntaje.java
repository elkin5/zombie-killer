...
public class Puntaje implements Serializable, Comparable<Puntaje> {
  ...
  /**
   * Puntaje mayor que el presente, esta referencia para ordenar en forma de �rbol binario
   */
  ...
  /**
   * m�todo que se encarga de agregar un puntaje en el �rbol binario con el score(puntaje en
   * n�meros) como criterio de ordenamiento
   * 
   * @param score
   */
  ...
  /**
   * agrega elementos a la lista pasada por par�metro de manera ordenada en forma ascendente
   * 
   * @param lista
   */
